...
public class HashMapCollection {
	...
	/**
 *  HashMap almacena elementos en pares "clave/valor" y se pude acceder a ellos mediante index.
 *  No es ordenado y permite datos duplicados
 */
	HashMap<String, String> capitals = new HashMap<String, String>();
	//Agregamos elementos "clave/valor" (.put)
	capitals.put("Villa","Tabasco");
	capitals.put("Monterrey","Nuevo Leon");
	capitals.put("Guadalajara","Jalisco");
	capitals.put("Merida","Yucatan");
	capitals.put("Puebla","Puebla");
	capitals.put("Chetumal","Quintanarro");
	...
	calificaciones.put("Eunice",7);
	calificaciones.put("Rodri",6);
	calificaciones.put("David", 8);
	calificaciones.put("Eli",7);
	
	for(Map.Entry<String, Integer> calificaiones )
